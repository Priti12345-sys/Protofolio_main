...
# Set page title
st.set_page_config(page_title="Pritee Shah", page_icon = "desktop_computer", layout = "wide", initial_sidebar_state = "auto")
...
footer:after{
    content:'Copyright © 2023 Pritee Shah';
    position:relative;
    color:black;
}
"""
...
img_nus = Image.open("images/nuspc.jpg")
...
with st.sidebar:
    ...
    youtube_url = "https://youtube.com/@priteeshah5913?si=-k-QQc_-wfo1eTJB"
    linkedin_url = "https://www.linkedin.com/in/pritee-shah-089100202/"
    github_url = "https://github.com/Priti12345-sys"
    wordpress_url = "https://pritishah.streamlit.app/"
    email_url = "mailto:shahpritee635@gmail.com"
    with st.container():
...
if choose == "About Me":
    ...
    with st.container():
        ...
        with left_column:
            ...
            st.write("👋🏻 Hi!, I'm Pritee. The web developer.")
            ...
            st.write("📄 [Resume (1 page)](https://drive.google.com/file/d/112ZeO3vvgry61NJcMQjPjBgAov9Fgedq/view?usp=drive_link)")
        with middle_column:
            st.empty()
        with right_column:
            st.image(img_utown)
    ...
    with st.container():
            ...
            with col1:
                st.empty()
            with col2:
                st.video("https://youtube.com/@priteeshah5913?si=-k-QQc_-wfo1eTJB")
            with col3:
                st.empty()
    st.markdown("""
...
# Create section for Work Experience
    ...
    with st.container():
        ...
        with text_column:
            st.subheader("Laravel developer, [HedgeDrip](https://hedgedrip.vercel.app)")
    ...
    with st.container():
        ...
        with text_column:
            st.subheader("Photoshop Intern [Groundup.ai](https://groundup.ai)")
            st.write("*July to December 2023 (Expected)*")
            st.markdown("""
            - Maintain consistency in design elements such as colors, fonts, and button styles throughout the UI.Consistency helps create a unified and professional look.
            - Consider the responsiveness of the UI across different screen sizes and devices. Test and optimize the design for both desktop and mobile experiences.
            - Establish a clear visual hierarchy to highlight important elements. Use size, color, and spacing to guide the user's attention to key areas of the interface.
            - Include visual cues or feedback for user interactions, such as button presses or form submissions. Feedback helps users understand that their actions have been recognized.
    ...
    with st.container():
        ...
        with image_column:
            st.image(img_iasg)
        with text_column:
            st.subheader("Counsellor, [Immigration@SG LLP]")
            st.write("*January 2019 to October 2020* |")
            st.markdown("""
            - Help clients set realistic and achievable goals. Develop strategies to support them in reaching those goals.
            - Encourage open communication and seek feedback from clients to improve your counseling approach. Continuous improvement is key in this field..
            - Develop skills in documenting financial transactions accurately and preparing reports. Attention to detail is crucial in financial documentation.

            `Form handling` `Customer Care`
            """)
    with st.container():
        image_column, text_column = st.columns((1, 5))
        with image_column:
            st.image(img_iasg)
        with text_column:
            st.subheader("Bank Intern, [Immigration@SG LLP]")
            st.write("*October 2018 to January 2019* |")
            st.markdown("""
               - Work well within a team environment, as collaboration is often essential in banking roles. Effective teamwork enhances productivity and efficiency.
               - Cultivate problem-solving skills to address challenges that may arise in day-to-day banking operations.
               - Develop skills in documenting financial transactions accurately and preparing reports. Attention to detail is crucial in financial documentation.

               `Remittance` `Form handling` `Customer Care`
               """)
    st.markdown('''
    <style>
...
# Create section for Technical Skills
    ...
    txt3("Academic Interests","`Data Visualization`, `Web Developments`, `Recommendation Systems`, `Natural Language Processing`")
...
#st.write("---")
    ...
    if selected == "Summary":
        ...
        with st.container():
            ...
            with image_column:
                st.image(img_nus)
            with text_column:
                st.subheader("Bachelor in BIT ")
                st.write("Relevant Coursework: Introduction to Business Information Technology ,Database Management Systems, Business Analysis, Systems Analysis and Design, Programming Fundamentals, Web Development, Data Analytics and Visualization, Business Intelligence, Information Security and Risk Management , Networking Fundamentals, Enterprise Resource Planning (ERP) Systems, IT Governance and Compliance, Business Process Reengineering, Thesis based on machine learning")
        ...
        with st.container():
            ...
            with image_column:
                st.image(img_tpjc)
            with text_column:
                st.subheader("+2 A Level - [Liverpool Internation College")
                st.write("Coursework: Principles of Management, Financial Accounting, Managerial Accounting, Marketing Management, Organizational Behavior,  Human Resource Management, Business Ethics and Corporate Social Responsibility, Business Law, Data Analysis for Businessy")

                st.markdown(""" 
                - Basketball player
                - [Business Design Thinking](https://www.coursera.org/courses?query=business%20management)
                """)
        with st.container():
            image_column, text_column = st.columns((1,2.5))
            with image_column:
                st.image(img_sji)
            with text_column:
                st.subheader("SLC O Level - [Lok Smiriti Higher Secondary School")
                st.write("Coursework: English, Mathematics, Additional Mathematics, Physics, Chemistry, History, Geography Elective, Nepali")
    ...
    with st.container():
        ...
        with text_column:
            ...
            mention(label="Github Repo", icon="github", url="https://github.com/Priti12345-sys",)
        with image_column:
    ...
    with st.container():
        ...
        with text_column:
            ...
            mention(label="Final Report", icon="📄", url="https://docs.google.com/document/d/1ta6F44BHDoDX8iKad_729O73bzCu3p45/edit?usp=drive_link&ouid=107744246975706523562&rtpof=true&sd=true",)
        with image_column:
            st.image(images_projects[3])
    with st.container():
        text_column, image_column = st.columns((3,1))
        with text_column:
            st.subheader("Data Science Project on Cataract Detection Syatem")
            ...
            st.markdown("""
            - Ran regression models to predict box office revenue (linear regression, CNN, support vector machines)
    ...
    with st.container():
        ...
        with text_column:
            ...
            mention(label="Github Code", icon="github", url="https://github.com/Priti12345-sys",)
        with image_column:
    ...
    with st.container():
        ...
        with text_column:
            ...
            mention(label="Google Drive", icon="🗂️", url="https://github.com/Priti12345-sys",)
        with image_column:
    ...
    with st.container():
        ...
        with text_column:
            ...
            """)
            #st.write("[Github Code](https://github.com/harrychangjr/get1030/blob/main/A0201825N%20-%20GET1030%20Tutorial%203.ipynb)")
            mention(label="Final Report", icon="📄", url="https://github.com/Priti12345-sys",)
        with image_column:
    ...
    with st.container():
        text_column, mid, image_column = st.columns((3,0.4,1))
        with text_column:
            st.subheader("Padmashree  ' Sports Club")
    ...
    resume_url = "https://drive.google.com/file/d/112ZeO3vvgry61NJcMQjPjBgAov9Fgedq/view?usp=drive_link"
    st.header("Resume")
    ...
    show_pdf("Pritishah_Resume.pdf")
    with open("Pritishah_Resume.pdf", "rb") as file:
        btn = st.download_button(
            label="Download Resume (1 page)",
            data=file,
            file_name="Pritishah_Resume.pdf",
            mime="application/pdf"
        )
elif choose == "Testimonials": 
    test_url = "https://pritishah.streamlit.app/g"
...
# Create section for Contact
    ...
    with st.container():
        ...
        with text_column:
            st.write("Let's connect! You may either reach out to me at shahpritee635@gmail.com or use the form below!")
        ...
        with image_column:
            st.image(img_ifg)
st.markdown("*Copyright © 2023 Pritee Shah*")
